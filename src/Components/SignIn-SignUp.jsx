...
export default function SignInAndUp(){
    ...
    return(
        <div className="w-96 h-3/5 rounded-lg flex flex-col gap-5 justify-center items-center bg-[#DDE6ED]">
            ...
            <button className="h-12 rounded-md bg-[#27374D] w-4/5 text-[#DDE6ED] hover:bg-[black]">Login</button>
            <p>Do not have the account click<span className="font-semibold cursor-pointer " onClick={handleToggle}> Here</span></p>
        </div>
    )
}